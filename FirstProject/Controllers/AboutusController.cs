...
namespace FirstProject.Controllers
{
    public class AboutusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Aboutid,Whatwedo,Ourmission,Ourgoal,Yearofexperience,Qualifieddoctor,Numberofsurgery,Patientperyear")] Aboutu aboutu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Aboutid,Whatwedo,Ourmission,Ourgoal,Yearofexperience,Qualifieddoctor,Numberofsurgery,Patientperyear")] Aboutu aboutu)
        {
