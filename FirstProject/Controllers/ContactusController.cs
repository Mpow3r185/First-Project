...
namespace FirstProject.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Contactid,Address,Phonenumber,Email,Locationmap")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Contactid,Address,Phonenumber,Email,Locationmap")] Contactu contactu)
        {
